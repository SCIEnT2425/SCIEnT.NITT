  ...
  useEffect(() => {
    const fetchSlotsAndBookings = async () => {
      try {
        ...
        // Fetch slots
        const slotsResponse = await axios.get(`${process.env.BACKEND_URL}/api/clubs/slots/available`, {
        ...
        // Fetch bookings
        const bookingsResponse = await axios.get(`${process.env.BACKEND_URL}/api/bookings/pastbookings`, {
          headers: { Authorization: `Bearer ${token}` },
